...
Nov 2025 Main Crop Start 160 155 4 151 170 Shortage
  ...
  useEffect(() => {
    const fetchPredictions = async () => {
      try {
        const prompt = `You are a production forecasting expert. Based on the following historical data (including sales, revenue, production, and inventory) along with production trends, predict weekly production (in units) for the next 4 weeks starting from December 2025.
  ...
  return (
    <div className="productioncontainer">
      <div className="greencontainer">
        <p className="graphtitle">Production</p>
          ...
          {loading && (
            <div style={{ 
              ...
              <div style={{ 
                ...
                ProVision is analyzing Production patterns...
              </div>
            </div>
          )}
